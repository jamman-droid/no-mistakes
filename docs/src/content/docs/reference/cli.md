...
Prints state-free, versioned JSON describing the immutable capabilities of the current binary. It does not open app state, inspect configuration, contact the daemon, or probe agent executables.
